...
## Smelting effects (제련 추가효과)

### Basic effects of weapon smelting (무기 제련 기본 효과)

Depending on the smelting level, the weapon's ATK or MATK increases. The increased amount is displayed in the status window as part of the right-side number.
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="20">ATK / MATK<br> Increase (증가량)</td>
      <td>1</td>
      <td>2</td>
      <td>3</td>
      <td>5</td>
